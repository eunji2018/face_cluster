...
def cluster(threshold, k):
    ...
    #
    # numpy.savetxt('face_rank_order\\face_rank_order_dist_2_210.txt', rank_order_dist)

    rank_order_dist = numpy.loadtxt('face_rank_order\\face_rank_order_dist_2_200.txt')
